...
class Service(models.Model):
    id = models.AutoField(primary_key=0)
...
class Customer(models.Model):
    ...
    service = models.ForeignKey(Service, on_delete=models.SET_NULL) #как сохранить данные, если компания удалит услугу? а пользователь не должен быть удален
